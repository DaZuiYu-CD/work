                ...
                <Row>
                    ...
                    <Col span='6' class="padding-left-10">
                        ...
                        <div class="exportable-table-download-con2">
                            ...
                            <div class="margin-top-10">
                                <span>输入文件名：</span>
                                <Input v-model="csvFileName" icon="ios-document-outline" placeholder="请输入文件名" style="width: 190px" />
                            </div>
                ...
                <Row>
                    ...
                    <Col span='6' class="padding-left-10">
                         <div class="margin-top-10 margin-left-10">
                            <span>输入文件名：</span>
                            <Input v-model="excelFileName" icon="ios-document-outline" placeholder="请输入文件名" style="width: 190px" />
                        </div>
